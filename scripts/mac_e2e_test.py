#!/usr/bin/env python3
"""
macOS End-to-End Test Script

This script runs a complete end-to-end test of the voice assistant system on macOS:
...
def interactive_test():
    ...
    print("\n============================================")
    print("   macOS Voice Assistant Interactive Test")
    print("============================================")
...
def main():
    """Main entry point."""
    parser = argparse.ArgumentParser(description="macOS Voice Assistant E2E Test")
